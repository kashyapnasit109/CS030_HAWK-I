...
async def detect_threat(
  ...
  rule_parameters: str = Form(...)
    ...
    # ── Step 1: Save Temporary Video File & Validate Duration ──────────
    ...
    try:
        ...
        if duration_sec > 30.0:
            raise HTTPException(status_code=400, detail=f"Video duration ({duration_sec:.1f}s) exceeds max limit of 30s.")
